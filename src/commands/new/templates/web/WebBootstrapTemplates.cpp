...
namespace vix::commands::new_cmd::templates
{
  ...
  std::string make_web_main_cpp(const std::string &projectName)
  {
    ...
    s += "/**\n";
    s += " * @file main.cpp\n";
    s += " * @brief Entry point for the " + projectName + " web application.\n";
    s += " */\n\n";

    s += "#include <" + projectName + "/app/AppBootstrap.hpp>\n\n";

    s += "/**\n";
    s += " * @brief Start the web application.\n";
    s += " *\n";
  ...
  std::string make_web_app_bootstrap_hpp(const std::string &projectName)
  {
    ...
    s += " * @brief Application bootstrap for the " + projectName + " web app.\n";
    s += " */\n\n";
    ...
    s += "{\n";
    s += "  /**\n";
    s += "   * @brief Owns the startup sequence of the web application.\n";
    s += "   *\n";
    s += "   * AppBootstrap keeps main.cpp minimal and centralizes configuration\n";
    s += "   * loading, Vix app creation, template/static directory setup,\n";
    ...
    s += "    /**\n";
    s += "     * @brief Run the web application.\n";
    s += "     *\n";
  ...
  std::string make_web_app_bootstrap_cpp(const std::string &projectName)
  {
    ...
    s += " * @brief Startup implementation for the " + projectName + " web app.\n";
    s += " */\n\n";
