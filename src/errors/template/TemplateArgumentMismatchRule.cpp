/**
 *
 *  @file TemplateArgumentMismatchRule.cpp
...
namespace vix::cli::errors::template_rules
{
  ...
  class TemplateArgumentMismatchRule final : public ITemplateErrorRule
  {
  public:
  ...
  {
    return std::make_unique<TemplateArgumentMismatchRule>();
  }
} // namespace vix::cli::errors::template_rules
